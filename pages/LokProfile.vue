<template>
  <div class="font-sans antialiased text-gray-900 leading-normal tracking-wider bg-cover" style="background-image:url('https://picsum.photos/id/572/1920/1080');">
      ...
      <!--Img Col-->
      <div class="w-full lg:w-2/5" v-if="profileLok">
        <!-- Big profile image for side bar (desktop) -->
        <!--
        -->
        <img :src="profileLok.pic" class="rounded-none lg:rounded-lg shadow-2xl hidden lg:block">
...
export default {
  ...
  async asyncData({isDev, route, store, env, params, query, req, res, redirect, error}) {
    return {
      profileLok: await API.getLokProfSettings()
    }
  },
  async mounted () {
  }
